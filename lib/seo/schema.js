...
export function personSchema(overrides = {}) {
  ...
  return {
    ...
    description:
      "Saurabh Singh is Co-Founder and Chief Technology Officer of ScaleDesk Technology, leading product and engineering.",
    ...overrides,
  };
}
...
/** Page-specific nodes only; the organization, founder and website nodes come from siteGraph() in the root layout. */
