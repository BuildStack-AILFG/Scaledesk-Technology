...
export const RESOURCES_NAV = [
  { label: "Insights", href: "/insights", blurb: "Practical thinking on AI, automation and growth." },
...
function buildMenus() {
  return {
    ...
    insights: {
      ...
      rail: [{ id: "insights", label: "Insights", items: RESOURCES_NAV.map((r) => ({ name: r.label, blurb: r.blurb, href: r.href })) }],
    },
    company: {
